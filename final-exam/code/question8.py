...
prime = 89
candidates = [79, 21, 7, 40]
group = PrimeCyclicGroupMult(prime)
print(group.primitives)
group.print_order()

for candidate in candidates:
    if group.is_generator(candidate):
        print(f"{candidate} is a generator")
    else:
        print(f"{candidate} is not a generator")
