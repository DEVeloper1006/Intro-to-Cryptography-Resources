...
print(sympy.isprime(4969))
group = PrimeCyclicGroupMult(4969)
print("Number of Generators:", len(group.primitives))
print(f"Probability of Generators = {len(group.primitives)} / {len(group.elements)}")